...
public class OfflineAllergenRepositoryTest extends BaseOfflineRepositoryTest {
     ...
     * - User entered correct allergen and valid and matching and non-matching ingredients
     * - User entered correct allergen but invalid ingredients
     * - User entered valid allergens and ingredients and submit to the API
     * */
